...
import { AUTH_SIGNUP_CAREGIVER, ROLE_CAREGIVER } from '../../utils/constants';
import styles from './AuthForm.module.css';
import { useAuthForm } from './useAuthForm';

const CaregiverSignup: React.FC = () => {
  ...
  const { values, errors, loading, serverError, updateField, handleSubmit } = useAuthForm({
    ...
    endpoint: AUTH_SIGNUP_CAREGIVER,
    role: ROLE_CAREGIVER,
    successRedirect: '/caregiver/onboarding',
    ...
    <div className={styles.main}>
      <div className={styles.container}>
        <div className={styles.formWrapper}>
          <h1 className={styles.title}>Sign Up as Caregiver</h1>
